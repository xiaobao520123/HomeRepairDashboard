            ...
            }
            {
              this.state.openDeleteDialog ? (
                <Dialog
                  ...
                  >
                    <DialogTitle id="alert-dialog-title">{"确认删除技术人员：" + this.state.list[this.state.userEditing].uid + "？"}</DialogTitle>
                    <DialogContent>
                      <DialogContentText id="alert-dialog-description">
                        你确定要删除这个技术人员吗？该操作只会撤销用户的技术人员身份。
                      </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                      ...
                      <TableRow>
                        ...
                        <TableCell>
                          <CustomInput id="input_uid"
                            inputProps={{
                              placeholder: "如果技术人员还没有注册，先到用户管理页面添加用户",
                            }}
                            formControlProps={{
                              fullWidth: true
                            }} 
